...
calendarHeat <- function(dates, 
  ...
  caldat$dotw <- as.numeric(format(caldat$date.seq, "%u")) - 1
  ...
  print(cal.plot <- levelplot(value~woty*dotw | yr, data=caldat,
                              ...
                              strip=TRUE,
                              main = paste("Valores medios diarios de PM10","Murcia - San Basilio",sep="\n"),
                              scales = list(
                                x = list(
                              ...
                              xlab="" ,
                              ylab="",
                              colorkey= list(col = calendar.pal(ncolors), width = 0.6, height = 0.5, title=expression(paste(mu, "g/", m^3,sep=""))),
                              subscripts=TRUE
